        ...
        <div className="flex justify-center mt-12">
            <div className="w-1/2 flex flex-col pb-12 shadow-2xl">
                <input
                    ...
                    className="mt-8 mr-6 ml-6 border rounded p-4"
                ...
                <input
                    type="file"
                    name="Asset"
                    className="my-4 mr-6 ml-6"
                    onChange={onChange}
                />
                {
                    fileUrl && (
                        <img className="rounded mt-4 mr-6 ml-6" width="350" src={fileUrl} />
                    )
                }
                <button onClick={createMarket} className="font-bold mt-4 mr-6 ml-6 bg-purple-500 text-white rounded p-4 shadow-lg">
